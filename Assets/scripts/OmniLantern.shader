...
Shader "Projection/OmniLantern"
{
	// properties of this shader
	Properties{
...
#include "UnityCG.cginc"
	...
	v2f vertMFVP(appdata v) {
		...
		v2f o;
		v.vertex.y += _focalLength;
		float3 mProjected = mul(unity_ObjectToWorld, v.vertex);  //current model matrix 
